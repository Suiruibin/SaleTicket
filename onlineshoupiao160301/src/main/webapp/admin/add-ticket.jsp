      ...
      <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
              ...
              <div class="add-article-box-content">
                <!--新增图书小类-->
                <input type="text" class="form-control" placeholder="输入余量" name="amount" autocomplete="off" id="amount">
            ...
            <div class="add-article-box" style="width:49%;display: inline-block;">
              ...
              <div class="add-article-box-content">
                <!--新增图书定价-->
                <input type="text" class="form-control" placeholder="输入定价" name="price" autocomplete="off" id="price">
...
<!--右侧栏目-->
          ...
          <div class="col-md-3">
            ...
            <%--<div class="add-article-box">--%>
              ...
              <%--<div class="add-article-box-content">--%>
                <%--<!--新增出版社名称-->--%>
                <%--<input type="text" class="form-control" placeholder="输入出版社名称" name="publish" autocomplete="off" id="publish">--%>
