      ...
      <ul class="nav nav-sidebar">
       <c:if test="${manageuser.mark==1}">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
           <br>
           <br>
            <h1 class="page-header">管理用户 <span class="badge">${totalCount }</span></h1>
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg"> 用户邮箱</span></th>
                        <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg"> 用户电话</span></th>
                        <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg"> 用户生日</span></th>	
                        <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg"> 用户性别</span></th>
                    ...
                    <tr>
                        ...
                        <td>
                         <c:if test="${manageuser.change==1 }">
                        	<%-- <a rel="${p.ID }" name="see" onclick="fn2('${p.ID}')">修改</a> --%> <a rel="${p.uid}" name="delete">删除</a>
                        </c:if> 
            ...
            <div style="margin-left:850px;height:60x;width:400px">
         					<c:if test="${curPage!=1}">
          							<a href="/UserListServlet?curPage=${curPage-1}" style="font-size:16px" onmouseover="javascript:this.style.color='deepskyblue';this.style.cursor='pointer'" onmouseout="javascript:this.style.color='black'">上一页</a>
          					
          					</c:if>
							<c:if test="${curPage<totalPage }">
									<a href="/UserListServlet?curPage=${curPage+1}" style="font-size:16px" onmouseover="javascript:this.style.color='deepskyblue';this.style.cursor='pointer'" onmouseout="javascript:this.style.color='black'">下一页</a>
          					</c:if>
...
<div class="modal fade" id="addUser" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
    <div class="modal-dialog" role="document" style="max-width:450px;">
        <form action="/Semester_Demo/AddManage" method="post" autocomplete="off" draggable="false">
...
<div class="modal fade" id="seechange" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel">
    <div class="modal-dialog" role="document" style="max-width:450px;">
        <form action="/Semester_Demo/UpdateManageUserServlet" method="post" autocomplete="off" draggable="false">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                if (window.confirm("此操作不可逆，是否确认？")) {
                    $.ajax({
                        ...
                        success: function (data) {
                        		...
                        		{
                        			alert(data);
                        			window.location.href="/UserListServlet?curPage="+${curPage};
                        		}
