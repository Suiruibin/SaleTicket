    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <h1 class="page-header">修改栏目</h1>
        ...
        <div class="form-group">
          ...
          <input type="text" id="category-name" name="name" value="${updatesupertypedetail.tname }" class="form-control" placeholder="在此处输入栏目名称" required autocomplete="off">
          <span class="prompt-text">这将是它在站点上显示的名字。</span> </div>
        <div class="form-group">
          <label for="category-alias">栏目别名</label>
          <input type="text" id="category-alias" name="alias" value="${updatesupertypedetail.aname }" class="form-control" placeholder="在此处输入栏目别名" required autocomplete="off">
        ...
        <div class="form-group">
          ...
          <input type="text" id="category-keywords" name="keywords" value="${updatesupertypedetail.keyword }" class="form-control" placeholder="在此处输入栏目关键字" autocomplete="off">
          <span class="prompt-text">关键字会出现在网页的keywords属性中。</span> </div>
        <div class="form-group">
          <label for="category-describe">描述</label>
          <textarea class="form-control" id="category-describe" name="describe" rows="4" autocomplete="off">${updatesupertypedetail.supdesc}</textarea>
          			...
          			function fn1()
          			{
          				...
          				var describe=$("#category-describe").val();
          			  	...
          			  	$.post(
          					...
          					{"name":name,"alias":alias,"fid":fid,"keywords":keywords,"describe":describe,"ID":${updateById } },
          					function(data)
          					{
          						alert(data);
          						window.location.href="/categorytypedetail.do?ID="+${updateById };
          					},
          					"json"
          			  );	
          			}
