          ...
          <table class="table table-striped table-hover">
            ...
            <c:forEach items="${spliteBookInfoplist }" var="p">
              <tr>
                	...
                	<td class="article-title">${p.ticketName }</td>
                	<td>${p.typeBIDName }</td>
                	...
                	<td>
               		 ...
               		 <td>
                		<c:if test="${p.newTicket==1 }" >是</c:if>
                		<c:if test="${p.newTicket==0 }" >否</c:if>
                	</td>
                	<td>
                	...
                	<td>
                		<c:if test="${manageuser.change==1 }">
                            <a href="/ShowBookInfo?ID=${p.ID }">详情</a>
