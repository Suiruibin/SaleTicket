...
//		$("#orderForm").submit();
        ...
        $.post(
            "/ProductPayforServlet",
            {"oid":oid,"address":address,"name":name,"telephone":telephone},
            function(data)
            {
...
<body>
	...
	<div class="container">
					...
					<tbody>
						...
						<c:forEach items="${order.orderItems }" var="orderItem">
							...
							<tr class="active">
								...
								<td width="30%"><a target="_blank">${orderItem.product.ticketName}</a></td>
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="/ProductPayforServlet" method="post"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin-top: 10px">
					...
					<table class="table" style="margin-bottom:0px;">
						...
						<tr>
							<td wdith="20%">订单编号:</td>
							<td width="80%">
								<input type="text" value="${order.oid}" readonly  id="orderId" class="form-control" name="votename" maxlength="10" autocomplete="off" />
							</td>
						</tr>
				...
				<div class="modal-footer">
					<button  onclick="confirmPay()" type="button" class="btn btn-default">确认支付</button>
				</div>
