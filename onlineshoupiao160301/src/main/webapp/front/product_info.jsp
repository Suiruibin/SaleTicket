...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectSeat() {
            ...
            window.location.href="/SelectSeatsServlet?pid=${product.ID}&location="+location+"&round="+round+"&price="+price;
...
<div class="container">
    ...
    <div class="row">
        <div
            ...
            <a href="/ProductSubTypeListServlet?ID=${typeID }&cid=${cid }&currentPage=${currentPage}">
                ${subTypename }
            </a>
        </div>
...
//                        alert(location)
                        window.open("https://restapi.amap.com/v3/staticmap?key=da3f89f7c685285905e53d03ba5e4482&size=880*880&zoom=11&markers=mid,0xFF0000,B:"+location+"&location="+location);
                    }
...
//                        发送请求
                ...
                <div
                    ...
                    <div
                        ...
                        <button class="btn btn-default" style="margin-left: 35%;margin-top: -20px">
                            <a  onclick="selectSeat()">选座购买</a>
                        </button>
                    </div>
                    ...
                    <div style=" text-align: center;">
                        ...
                        <div class="btn-group" style="margin-left: -35px;margin-top: 10px">
                            ...
                            <c:if test="${islove==1 }">
                                <a onclick="loveshoucang('${product.ID}')"  id="love"  class="btn btn-default" style="color:red;margin-left: 2%" >已收藏</a>
                            </c:if>
                            <c:if test="${islove==0 }">
