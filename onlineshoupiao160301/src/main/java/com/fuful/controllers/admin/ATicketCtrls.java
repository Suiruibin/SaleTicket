...
//        boolean judge=AticketService.findBookInfoExist(bookName);
    ...
    public String ImportExcelServlet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        return "redirect:/AdminGetInitBookInfoServlet?curPage=1";
    }
    ...
    public void AddTicketPlace(HttpServletRequest request,HttpServletResponse response) throws IOException {
        ...
        int res= AticketService.addTicketPlace(tid,place,location,town);
    ...
    public  void addPlaceTime(HttpServletRequest request,HttpServletResponse response) throws IOException {
        ...
        int res= AticketService.addPlaceTime(cityId,time,tid,amount,row,col);
        String message="success";
    ...
    @RequestMapping(value = "/DeleteBookCheckAllServlet",method = POST)
    public void DeleteBookCheckAllServlet(HttpServletRequest request,HttpServletResponse response) throws IOException {
        String  []  allbookinfo=request.getParameterValues("checkID");

        String message="";
        if(allbookinfo!=null)
        {
            boolean msg = false;
            for(int i=0;i<allbookinfo.length;i++)
            {
                msg=AticketService.deleteBookInfoByID(Integer.parseInt(allbookinfo[i]));
            }
